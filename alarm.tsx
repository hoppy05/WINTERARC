...
export default function AlarmScreen() {
  ...
  const getSnoozeRoast = () => {
    ...
    return snoozeRoasts[Math.floor(Math.random() * snoozeRoasts.length)];
  };
  ...
  const handleSnooze = () => {
    ...
    Alert.alert(
      ...
      roast,
      [
        { text: 'Fine, 5 more minutes', style: 'cancel', onPress: () => setIsAlarmActive(false) },
  ...
  const testAlarm = () => {
    ...
    const message = customMessage || getRandomRoast();
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingRow}>
            ...
            <Switch
              ...
              thumbColor={alarmEnabled ? '#ffffff' : '#666666'}
            />
          </View>
          ...
          <View style={styles.settingRow}>
            ...
            <Switch
              ...
              trackColor={{ false: '#333333', true: '#00BFFF' }}
              thumbColor={voiceEnabled ? '#ffffff' : '#666666'}
            />
          </View>
          ...
          <View style={styles.settingRow}>
            ...
            <Switch
              ...
              trackColor={{ false: '#333333', true: '#00BFFF' }}
              thumbColor={requireProof ? '#ffffff' : '#666666'}
            />
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity
            ...
            onPress={() => Alert.alert('Saved', 'Custom message updated')}
          >
